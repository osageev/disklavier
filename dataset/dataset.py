...
def segment_midi_old(input_file_path: str, params):
    ...
    This function reads a MIDI file, extracts its tempo from the filename, and segments it into smaller MIDI files each containing a specified number of beats. The function adjusts tempo and track end as necessary for each segment.
    """
